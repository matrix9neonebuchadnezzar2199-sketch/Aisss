...
INSERT INTO sources (id, name, sort_order) VALUES
  ('07100000-0000-4000-8000-000000000001', '公開情報', 1),
  ('07100000-0000-4000-8000-000000000002', '内部資料', 2)
ON CONFLICT (id) DO NOTHING;

INSERT INTO handling_types (id, name, sort_order) VALUES
  ('07200000-0000-4000-8000-000000000001', '通常', 1),
  ('07200000-0000-4000-8000-000000000002', '機微', 2)
ON CONFLICT (id) DO NOTHING;

INSERT INTO reliability_levels (id, name, sort_order) VALUES
  ('07300000-0000-4000-8000-000000000001', '高', 1),
  ('07300000-0000-4000-8000-000000000002', '中', 2)
ON CONFLICT (id) DO NOTHING;

INSERT INTO accuracy_levels (id, name, sort_order) VALUES
  ('07400000-0000-4000-8000-000000000001', '確認済', 1),
  ('07400000-0000-4000-8000-000000000002', '未確認', 2)
ON CONFLICT (id) DO NOTHING;

INSERT INTO rank_levels (id, name, sort_order) VALUES
  ('07500000-0000-4000-8000-000000000001', 'A', 1),
  ('07500000-0000-4000-8000-000000000002', 'B', 2)
ON CONFLICT (id) DO NOTHING;

INSERT INTO conditions (id, name, search_policy, quote_policy, export_policy, priority)
VALUES
  ('07600000-0000-4000-8000-000000000001', '印刷禁止', 'allow', 'allow', 'deny_print', 10),
  ('07600000-0000-4000-8000-000000000002', '複製禁止', 'allow', 'allow', 'deny_copy', 10),
  ('07600000-0000-4000-8000-000000000003', '照会禁止', 'restricted', 'summarize_only', 'deny_all', 20)
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (
    '07700000-0000-4000-8000-000000000142',
    'CASE-2026-00142',
    'DOC-2026-0042',
  ...
  (
    '07700000-0000-4000-8000-000000000138',
    'CASE-2026-00138',
    'DOC-2026-0038',
    '〇〇地域経済動向レポート',
    ...
    '07200000-0000-4000-8000-000000000002',
...
VALUES
  ('07700000-0000-4000-8000-000000000142', 'c1000000-0000-4000-8000-000000000001'),
  ('07700000-0000-4000-8000-000000000138', 'c1000000-0000-4000-8000-000000000002')
ON CONFLICT DO NOTHING;

INSERT INTO case_conditions (case_id, condition_id)
VALUES
  ('07700000-0000-4000-8000-000000000138', '07600000-0000-4000-8000-000000000003')
ON CONFLICT DO NOTHING;
